    ...
    public partial class Settings : ModuleSettingsBase
    {
        ...
        public override void LoadSettings()
        {
            try
            {
                ...
                {
                    Components.SettingsRepository settingsCtrl = new Components.SettingsRepository(this.TabModuleId);

                    /* uncomment to load saved settings in the text boxes
                    txtSetting1.Text = settingsCtrl.Setting1;
                    txtSetting2.Text = settingsCtrl.Setting2;
                    */
        ...
        public override void UpdateSettings()
        {
            try
            {
                ...
                //settingsCtrl.Setting2 = txtSetting2.Text;
            }
            catch (Exception exc) //Module failed to load
            {
                Exceptions.ProcessModuleLoadException(this, exc);
